...
void main() {
  ...
  runApp(
    /*
     Provide the model to all widgets within the app. We're using ChangeNotifierProvider
     because that's a simple way to rebuild widgets when a model changes.
     We could also just use Provider, but then we would have to listen to Counter ourselves.
     Read Provider's docs to learn about all the available providers.
    */
    /*为应用程序内的所有Widget提供model。我们正在使用 ChangeNotifierProvider
     因为这是在model更改时重建widget的简单方法。
     我们也可以只使用 Provider，但随后我们必须自己听 Counter 的声音。
    */
